...
var AccountsettingsPage = /** @class */ (function () {
    function AccountsettingsPage(location, navCtrl, file, camera, actionSheetController, server, toastController, loadingController) {
    ...
    AccountsettingsPage.prototype.pickImage = function (sourceType) {
        var _this = this;
        var options = {
            quality: 100,
    ...
    AccountsettingsPage.prototype.selectImage = function () {
    ...
    AccountsettingsPage.prototype.goToChangePassword = function () {
        this.navCtrl.navigateForward('tabs/changepassword');
    };
    AccountsettingsPage.prototype.getuser = function () {
        return __awaiter(this, void 0, void 0, function () {
            var loading, params;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    AccountsettingsPage.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var param, loading_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.name == undefined || this.phone == undefined || this.name == "" || this.phone == "")) return [3 /*break*/, 1];
                        this.presentToast("Name and phone number is mandatory");
                        return [3 /*break*/, 4];
    ...
    AccountsettingsPage.prototype.presentToast = function (txt) {
        return __awaiter(this, void 0, void 0, function () {
            var toast;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AccountsettingsPage.prototype.selectMember = function (event) {
        if (event.target.checked) {
            this.hideEmail = true;
            console.log("hidemeail", this.hideEmail);
        }
        else {
