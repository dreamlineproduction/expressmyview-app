...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(navCtrl, server, toastController, loadingController) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.server.register(data).subscribe(function (response) {
                            loading.dismiss();
    ...
    RegisterPage.prototype.presentToast = function (txt) {
        return __awaiter(this, void 0, void 0, function () {
            var toast;
            return __generator(this, function (_a) {
                switch (_a.label) {
