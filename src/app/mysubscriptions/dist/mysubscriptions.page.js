...
exports.MysubscriptionsPage = void 0;
var core_1 = require("@angular/core");
var MysubscriptionsPage = /** @class */ (function () {
    function MysubscriptionsPage(location, navCtrl, server, toastController, loadingController, router) {
    ...
    MysubscriptionsPage.prototype.getMySubscriptions = function () {
    ...
    MysubscriptionsPage.prototype.goBack = function () {
        this.location.back();
    };
    MysubscriptionsPage.prototype.goToChannelDetails = function (id) {
        var navData = {
            queryParams: {
                id: id
            }
    ...
    MysubscriptionsPage = __decorate([
        core_1.Component({
