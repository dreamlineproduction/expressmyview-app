...
var Tab4Page = /** @class */ (function () {
    function Tab4Page(navCtrl, server, toastController, loadingController, router) {
    ...
    Tab4Page.prototype.getAllPodcasts = function () {
    ...
    Tab4Page.prototype.presentToast = function (txt) {
        return __awaiter(this, void 0, void 0, function () {
            var toast;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Tab4Page.prototype.goToChannelDetails = function (id) {
        var navData = {
            queryParams: {
                id: id
            }
